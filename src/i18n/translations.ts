export const translations = {
  es: {
    ...
    'shop.vehicles.desc': 'Potencia tu hogar y reduce tu factura de electricidad.',
    'shop.order': 'Ordenar',
    'shop.learn': 'Más Info',
  ...
  en: {
    ...
    'shop.vehicles.desc': 'Power your home and reduce your electricity bill.',
  ...
  pt: {
    ...
    'shop.vehicles.desc': 'Alimente sua casa e reduza sua conta de energia.',
  ...
  zh: {
    ...
    'shop.vehicles.desc': '为您的家供电并降低电费。',
    'shop.order': '立即订购',
    'shop.learn': '了解更多',
  ...
  ar: {
    ...
    'shop.vehicles.desc': 'زود منزلك بالطاقة وخفض فاتورة الكهرباء.',
